...
public class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	public int expired;
	public int succesfullyExecuted;
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			...
			double expiry = rcl.expiry;
			if(expiry==0){
				System.out.println("Nooooooooooooooooooooooooooooooooooooooo");
			}
			if (remainingLength == 0 || expiry<=CloudSim.clock()) {// finished: remove from the list
				if(expiry<=CloudSim.clock()){
					System.out.println("Expireddddddddddddddddddddd");
					...
					System.out.println("Nottttttttttttttttttttttttttttt");
					System.out.println(expiry);
					System.out.println(CloudSim.clock());
					succesfullyExecuted++;
					System.out.println(succesfullyExecuted);
				}
				toRemove.add(rcl);
				cloudletFinish(rcl);
				continue;
